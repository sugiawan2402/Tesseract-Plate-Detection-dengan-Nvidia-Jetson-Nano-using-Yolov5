...
def detect(opt):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        #print(pred)
        # Process detections
	pytesseract.pytesseract.tesseract_cmd = '/usr/local/src/openalpr/tesseract-ocr/tessdata'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default="vid.mp4", help='source')  # file/folder, 0 for webcam
